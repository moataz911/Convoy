...
# كلا الخطين مضمّنان: Amiri (مرجعية كاملة) + Cairo (احتياطي)
source.include_patterns = Amiri-Regular.ttf,Cairo-Bold.ttf

version = 1.0

# arabic-reshaper: يصل الحروف العربية
# python-bidi:     يطبّق خوارزمية RTL
