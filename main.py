...
def ar(text: str) -> str:
    ...
    try:
        ...
        # ‭ (LRO) + ‬ (PDF): prevents SDL2_ttf from applying BiDi again
        # arabic_reshaper shapes letters + _bidi() reverses order for Kivy LTR engine
        # LRO wrapper tells SDL2_ttf "already ordered for LTR display, don't re-reverse"
        return '‭' + bidi_text + '‬'
    except Exception:
        return text
