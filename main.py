    ...
    def _make_field_widget(self, fd, current=""):
        ...
        if ftype == "text":
            ...
            if fd.get("input_type") == "number":
                ...
                # نص عربي: _raw_value يخزّن القيمة الخامة، _shape_ev يؤجل التشكيل
            ...
            # وضع التعديل: فقط للحقول العربية (الأرقام تهيّأ في _init_num أعلاه)
            if current and fd.get("input_type") != "number":
